...
import typing
import logging
from profiling.counter_functions import counter_parameters, counter_conv, \
...
def count_convNd(m: _ConvNd, x: typing.Tuple[torch.Tensor,], y: torch.Tensor):
    x = x[0]
...
def count_convNd_ver2(m: _ConvNd, x: typing.Tuple[torch.Tensor,], y: torch.Tensor):
    x = x[0]
